...
const SCENARIOS: Scenario[] = [
  {
    ...
    params: { w: 5, sigma: 1, T: 3.5, c_m: 1, V: 40, theta: 180 },
  },
  {
    ...
    params: { w: 5, sigma: 1.5, T: 0.5, c_m: 1, V: 100, theta: 20 },
  },
  {
    id: 'rand-nightmare',
    ...
    params: { w: 5, sigma: 1.5, T: 2, c_m: 4.5, V: 70, theta: 80 },
  },
  {
    id: 'cheap-talk',
    ...
    params: { w: 5, sigma: 1, T: 2, c_m: 0.1, V: 50, theta: 100 },
  },
  {
    id: 'high-stakes',
    ...
    params: { w: 5, sigma: 1, T: 2, c_m: 1, V: 100, theta: 100 },
  },
  {
    id: 'fog-of-war',
    name: 'Fog of War',
    ...
    params: { w: 5, sigma: 3, T: 2, c_m: 1, V: 50, theta: 100 },
  },
];
