  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white flex flex-col">
      ...
      <main className="flex-1 flex flex-col lg:flex-row gap-4 p-4 min-h-0">
        ...
        <section className="hidden lg:flex lg:flex-1 flex-col gap-4 min-w-0 min-h-0">
          <WorldMap />
        </section>

        {/* Right Sidebar - Equilibrium & Simulation */}
        <aside className="w-full lg:w-96 lg:flex-shrink-0 flex flex-col gap-4 overflow-hidden">
          <EquilibriumDisplay />
